...
<html lang="en">
    <head>
        ...
        <title>@yield('title', 'Confecciones Abigail')</title>
    </head>
    <body>
    <!-- header -->
        <nav class="navbar navbar-expand-lg navbar-dark bg-secondary py-3">
            <div class="container">
                ...
                <a class="navbar-brand" href="{{ route('home.index') }}">Confecciones Abigail</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    ...
                    <a class="nav-link active" href="{{ route('home.about') }}">Mi Información</a>
                    <div class="vr bg-white mx-2 d-none d-lg-block"></div>
                        @guest
                            ...
                            <a class="nav-link active" href="{{ route('myaccount.orders') }}">Mis ordenes</a>
        ...
        <header class="masthead bg-primary text-white text-center py-4">
            <div class="container d-flex align-items-center flex-column">
                <h2>@yield('subtitle', 'Confecciones Abigail')</h2>
            </div>
        </header>
        <!-- header -->
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container">
                <small>
                    Tienda de - <a class="text-reset fw-bold text-decoration-none" target="_blank"
